import {s as ssr_context,g as sanitize_props,h as attributes}from'./chunk-DxGxG4u5.js';/**
 * @param {string} value
 */
function html(value) {
...
function generateIcon(icon, props) {
	...
	$$renderer.component(($$renderer) => {
		...
		if (// Increase counter when loaded to force re-calculation of data
		// Force re-render
		// Abort loading when component is destroyed
		data) {
			$$renderer.push('<!--[-->');
